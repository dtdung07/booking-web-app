...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['maBan']) && isset($_POST['trangThai'])) {
    require_once $_SERVER['DOCUMENT_ROOT'] . '/booking-web-app/app/models/TableStatusManager.php';
    ...
    echo '<script>window.location.href = "?page=admin&section=table&action=status&maCoSo=' . $_POST['maCoSo'] . '&thoiGianBatDau=' . urlencode($thoiGianBatDau) . '&thoiGianKetThuc=' . urlencode($thoiGianKetThuc) . '";</script>';
    exit;
}
...
// Lấy tham số từ URL
if (isset($_GET['maCoSo'])) {
    $maCoSo = (int)$_GET['maCoSo'];
}
    ...
    <form method="GET" class="mb-4">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <select name="maCoSo" class="form-select" required onchange="this.form.submit()">
